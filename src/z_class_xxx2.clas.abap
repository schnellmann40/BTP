...
class z_class_xxx2 definition
  ...
  public section.
    ...
    methods constructor
              importing
                i_value type z_class_xxx2=>t_value.
    ...
    methods value
              returning
                value(r_value) type z_class_xxx2=>t_value.
    ...
    class-methods from_uuid_or_fallback
                    returning
                      value(r_unique_cid) type ref to z_class_xxx2.

  protected section.

    "! <p class="shorttext synchronized" lang="EN"></p>
    data a_value type z_class_xxx2=>t_value.

    "! <p class="shorttext synchronized" lang="EN"></p>
    class-data a_random_int_generator type ref to cl_abap_random_int8.

endclass.
class z_class_xxx2 implementation.
  ...
  method from_uuid_or_fallback.
    ...
    try.
      ...
      r_unique_cid = new #( |cid_fallback&{ z_class_xxx2=>a_random_int_generator->get_next( ) }| ).
  ...
  method class_constructor.
    ...
    z_class_xxx2=>a_random_int_generator = cl_abap_random_int8=>create( seed = cl_abap_context_info=>get_system_date( ) + cl_abap_context_info=>get_system_time( ) ).
